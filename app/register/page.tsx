          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                maxLength={30}
              />
              <p className="mt-1 text-xs text-gray-500">3-30 karakter, sadece harf, rakam, _ ve -</p>
            </div>
            ...
            <div>
              ...
              <input
                ...
                minLength={8}
              />
              <p className="mt-1 text-xs text-gray-500">En az 8 karakter, 1 büyük harf, 1 küçük harf, 1 rakam</p>
            </div>
